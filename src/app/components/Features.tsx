...
const Features = () => {
  return (
    <section className='bg-black pb-52 -mt-[0.2px]'>
      ...
      <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
        ...
        <BentoTilt className='bento-tilt_1 me-14 md:col-span-1 md:me-0'>
          <BentoCard src='/videos/feature-4.mp4' title={<>Az<b>u</b>l</>} description='A gamified social hub, adding a new dimension of play to social interaction for Web3 communities.'/>
        </BentoTilt>
