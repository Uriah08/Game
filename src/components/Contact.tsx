...
const ImageClipBox = ({ src, clipClass }: Props) => (
    <div className={clipClass}>
        <Image src={src} height={1000} width={1000} alt='image'/>
    </div>
)
    ...
    <div id='contact' className='my-20 min-h-96 w-screen px-10'>
        <div className='relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden'>
            ...
            <div className='flex flex-col items-center text-center'>
                ...
                <p className='special-font mt-10 w-full font-zentry text-5xl leading-[0.9] md:text-[6rem]'>Let&apos;s b<b>u</b>ild the<br />n<b>e</b>w era of<br />gami<b>n</b>g toget<b>h</b>er</p>
                <Button title='contact us' containerClass='mt-10 cursor-pointer' id='contact'/>
            </div>
        </div>
    </div>
  )
