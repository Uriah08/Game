    ...
    <section className='min-h-dvh w-screen bg-black text-blue-50'>
        <div className="flex size-full flex-col items-center py-10 pb-24">
            ...
            <div className='relative size-full'>
                <AnimatedTitle title="The St<b>o</b>ry of<br />a hidden re<b>a</b>lm" containerClass='mt-5 pointer-events-none mix-blend-difference relative z-10'/>
                <div className='story-img-container'>
                    <div className='story-img-mask'>
                        <div className='story-img-content'>
                            <Image onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeaves} onMouseUp={handleMouseLeaves} onMouseEnter={handleMouseLeaves} ref={frameRef} src={'/img/entrance.webp'} width={3200} height={2000} alt='story image' className='object-contain'/>
                        </div>
                    </div>
                    <RoundedCorners/>
                </div>
